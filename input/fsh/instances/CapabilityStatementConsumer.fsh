...
* name = "RefertoDiLaboratorio_Consumer BOZZA"
* title = "Referto di Laboratorio - Consumer (client)"
* status = #draft
* experimental = false
* date = "2023-04-05"
* description = "Versione BOZZA di CapabilityStatement per il Consumer definito nelle specifiche del Referto di Laboratorio"
* kind = #requirements
* fhirVersion = #4.0.1

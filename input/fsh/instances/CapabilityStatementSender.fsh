...
Usage: #definition
//* url = "http://hl7.it/fhir/lab-report/CapabilityStatement/CapabilityStatementSenderLabReport"
* name = "RefertoDiLaboratorio_Sender BOZZA"
* title = "Referto di Laboratorio - Sender (client)"
* status = #draft
* experimental = false
* date = "2023-04-05"
* description = "Versione BOZZA di CapabilityStatement per il Sender definito nelle specifiche del Referto di Laboratorio"
* kind = #requirements
* fhirVersion = #4.0.1
...
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al Practitioner"
...
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base all'identifier di Composition"
...
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al validatore di Composition"

* rest.resource[=].searchParam.name = "author"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-identifier"
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base all'autore di Composition"

* rest.resource[=].searchParam.name = "category"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-category"
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base alla categoria di Composition"

* rest.resource[=].searchParam.name = "confidentiality"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-confidentiality"
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base alla confidenzialità di Composition"
...
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al contesto di Composition"

* rest.resource[=].searchParam.name = "date"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-date"
* rest.resource[=].searchParam.type = #date
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base alla data di creazione di Composition"
...
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base all'incontro associato a Composition"
...
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base alle risorse referenziate dalle section di Composition"

* rest.resource[=].searchParam.name = "related-id"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-related-id"
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base in base all'identificativo delle Compostion correlate alla Composition"

* rest.resource[=].searchParam.name = "releted-ref"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-related-ref"
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base in base alle Compostion correlate alla Composition"

* rest.resource[=].searchParam.name = "patient"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-patient"
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al paziente di Composition"
...
* rest.resource[=].searchParam.type = #date
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al periodo di Composition"

* rest.resource[=].searchParam.name = "section"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-"
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al codice della section di Composition"

* rest.resource[=].searchParam.name = "status"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-status"
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base allo stato di Composition"

* rest.resource[=].searchParam.name = "subject"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-subject"
* rest.resource[=].searchParam.type = #reference
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al soggetto di Composition"
...
* rest.resource[=].searchParam.type = #string
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al titolo di Composition"

* rest.resource[=].searchParam.name = "type"
* rest.resource[=].searchParam.definition = "http://hl7.org/fhir/SearchParameter/Composition-type"
* rest.resource[=].searchParam.type = #token
* rest.resource[=].searchParam.documentation = "Permette di ricercare in base al tipo di Composition"

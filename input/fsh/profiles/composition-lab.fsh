...
* extension[order].valueReference only Reference( ServiceRequest or RequestGroup)

/*  TO DO Header
- add optional data enterer
- add optional ItLabReport Information Recipient
...
* subject only Reference(PatientItLabReport)
* subject 1..1
...
* section[no-subsections].code from LabStudyTypesItLabReport (preferred)
...
* section[no-subsections].entry only Reference (DiagnosticReportItLabReport or ObservationResultsLaboratoryItLabReport)
...
// Should we also include the LabStudyTypesItLabReport (preferred) binding here?
* section[subsections].code from LabStudyTypesItLabReport (preferred)
// * section.code = http://loinc.org#75310-3 (exactly) // add binding
...
* section[subsections].section 1..
  ...
  * section.code only http://hl7.org/fhir/uv/ips/StructureDefinition/CodeableConcept-uv-ips
  // And include the LabStudyTypesItLabReport (preferred) binding for the subsection here?
  * section.code from LabStudyTypesItLabReport (preferred)
  // * section.code = http://loinc.org#75310-3 (exactly) // add binding
  * section.text 1..
  * section.entry 1..
  * section.text only Narrative
  ...
  // RH - allow a choice of both DiagnosticReport (optional) and Observation Results Lab (can be a single observation, or a grouper of nested observations)
  * section.entry only Reference (DiagnosticReportItLabReport or ObservationResultsLaboratoryItLabReport)

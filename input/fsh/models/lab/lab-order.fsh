...
* -> "Composition.extension('http://hl7.it/fhir/lab-report/StructureDefinition/composition-basedOn-order-or-requisition').valueReference.resolve()"				
* orderDetails -> "Composition.extension('http://hl7.it/fhir/lab-report/StructureDefinition/composition-basedOn-order-or-requisition').valueReference.resolve()"				

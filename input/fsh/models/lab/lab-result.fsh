...
* -> "Observation.conformsTo('http://hl7.it/fhir/lab-report/StructureDefinition/Observation-results-laboratory-eu-xeh')"				
...
* observation -> "Observation.conformsTo('http://hl7.it/fhir/lab-report/StructureDefinition/Observation-results-laboratory-eu-xeh')"				

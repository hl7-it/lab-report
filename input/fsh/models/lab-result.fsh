...
* -> "Observation.conformsTo('http://hl7.it/fhir/lab-report/StructureDefinition/observation-it-lab')"				
...
* osservazione -> "Observation.conformsTo('http://hl7.it/fhir/lab-report/StructureDefinition/observation-it-lab')"				

...
Alias: $uri-idEni = http://hl7.it/fhir/lab-report/ValueSet/VstipoIdentificatore //http://hl7.it/fhir/lab-report/CodeSystem/it-identifier-type
...
Alias: $istat-stato = http://hl7.it/fhir/lab-report/ValueSet/istat-stato // COntrollare la differenza con $istat-stati
